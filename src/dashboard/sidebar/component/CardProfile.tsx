...
function CardProfile(props: Data & { setState: React.Dispatch<ActionState> }) {
  ...
  return (
    <Link
      className="flex items-center py-3 px-4 border border-transparent rounded-lg outline-hidden outline-offset-1 text-xs text-gry-600 cursor-pointer even:border-gry-100 hover:text-black hover:bg-gry-50 active:bg-gry-100 focus-visible:outline-pur-700"
      to={`instance/${id}`}
    >
